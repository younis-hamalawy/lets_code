            ...
            <div className="first">
              <div className="lets-code-button">
                {this.props.session.currentUser
                  ? <Link className="host-button" to={'/cities'}>
                      let's code together!
                    </Link>
                  : <Link className="host-button" to={'/signUp'}>
                      let's code together!
                    </Link>}
              </div>
            </div>
          ...
          <div className="splash-body">
            ...
            <div className="entry">
              <img
                ...
                src={'https://res.cloudinary.com/flying-monkey/image/upload/v1501218843/3_copy_xjycpj.png'}
                alt="splash-image"
              />
              <div className="weird">
                <h2>It's weird</h2>
                <p>
                  Everyone is stepping a little out of their comfort zone. This makes it so much easier to actually
                  learn something unexpected. Because open minds are a prerequisite around here
                </p>
              </div>
            </div>
            <div className="entry">
              <div className="weird">
                ...
                <p>
                  In all likelihood, our paths won’t cross for any reason. So often, we only meet people through work,
                  school, or friends of friends. And even then, it’s questionable. So basically, we manufacture
                  serendipity
                </p>
              </div>
              <img
            ...
            <div className="entry">
              ...
              <div className="weird">
                ...
                <p>
                  And your eyes are made…for eye contact! Real humans are so much cooler than their tweets or Instagram
                  pictures. Let's Code has real humans! nofilter!
                </p>
              </div>
            </div>
            <div className="lets-code-button">
